"""
Django settings for belleapp project.
...
ALLOWED_HOSTS = ['54.208.147.46', os.getenv("APP_HOST"), '127.0.0.1']
...
WSGI_APPLICATION = 'belleapp.wsgi.application'
